...
var nodesDatasFull = [
    ...
    { id: 130, label: 'CyberGammaForge VM', containerOpened: false, iscontainer: true, description: "The VM hosting the CyberGammaForge service.", status: "on", status_url: "https://uptime.gh.gzod01.fr/history/cyber-gamma-forge-vm", homepage: "https://forge.vm.cybergamma.group" },
    { id: 131, label: 'CyberGammaForge', description: "The official CyberGammaForge service for hosting open source projects.", status: "on", status_url: "https://uptime.gh.gzod01.fr/history/cyber-gamma-forge", homepage: "https://forge.cybergamma.group" },
    { id: 140, label: 'CyberGammaGroup Communications VM', containerOpened: false, iscontainer: true, description: "The VM dedicated to CyberGammaGroup communication services.", status: "on", status_url: "https://uptime.gh.gzod01.fr/history/cyber-gamma-group-communications-vm", homepage: "https://comm.vm.cybergamma.group" },
    ...
    { id: 171, label: 'CyberGammaChat', description: "The official chat service for CyberGammaGroup.", status: "on", status_url: "https://uptime.gh.gzod01.fr/history/cyber-gamma-chat", homepage: "https://ess.cybergamma.group" }
];
